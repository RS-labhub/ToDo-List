...
export const TodoItem: React.FC<TodoItemProps> = ({
  ...
  return (
    <div
      className={
        "flex items-center justify-between px-4 py-2 group bg-green-300" +
        (hasBorder ? " border-b" : "")
      }
    >
      ...
      <div>
        ...
        <button
          ...
          className="ml-2 text-green-900 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
